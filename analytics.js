...
const c={en:{tag:"Independent travel planning for El Salvador.",explore:"Explore",map:"Interactive map",guides:"Travel guides",bus:"Bus guide",services:"Travel services",partners:"Contact & partners",contact:"Email us",join:"Become a partner",claim:"Claim a listing",legal:"Legal",privacy:"Privacy Policy",terms:"Terms of Use",affiliate:"Affiliate Disclosure",language:"Languages",rights:"All rights reserved."},es:{tag:"Planificación de viajes independiente para El Salvador.",explore:"Explorar",map:"Mapa interactivo",guides:"Guías de viaje",bus:"Guía de buses",services:"Servicios de viaje",partners:"Contacto y socios",contact:"Escríbenos",join:"Hazte socio",claim:"Reclamar un anuncio",legal:"Legal",privacy:"Política de privacidad",terms:"Condiciones de uso",affiliate:"Divulgación de afiliados",language:"Idiomas",rights:"Todos los derechos reservados."},fr:{tag:"Planification de voyage indépendante pour le Salvador.",explore:"Explorer",map:"Carte interactive",guides:"Guides de voyage",bus:"Guide des bus",services:"Services de voyage",partners:"Contact et partenaires",contact:"Nous écrire",join:"Devenir partenaire",claim:"Revendiquer une fiche",legal:"Mentions légales",privacy:"Politique de confidentialité",terms:"Conditions d’utilisation",affiliate:"Divulgation d’affiliation",language:"Langues",rights:"Tous droits réservés."}}[l];
